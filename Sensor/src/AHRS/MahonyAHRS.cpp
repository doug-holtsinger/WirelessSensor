...
#define sampleFreqDef    416.0f   // 416.0f      // 416.0f    // sample frequency in Hz  512.0f original
...
float q0X = 1.0f, q1X = 0.0f, q2X = 0.0f, q3X = 0.0f;    // quaternion of sensor frame relative to auxiliary frame
