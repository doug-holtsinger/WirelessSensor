...
module1 = Extension('visualizer',
                    ...
                    extra_objects = ['/home/pi/Togl/Togl2.0.DEBUG/libToglstub2.0.a'],
                    extra_compile_args = ['-Wno-psabi', '-fPIC', '-Wall', '-ftree-vectorize' , '-pipe', '-fomit-frame-pointer' , '-Wl,--export-dynamic'],
                    ...
                    library_dirs = [ '/opt/vc/lib/', '/opt/vc/src/hello_pi/libs/ilclient', '/opt/vc/src/hello_pi/libs/vgfont', '/opt/vc/src/hello_pi/libs/revision', '/usr/lib/Togl2.0/', '/usr/lib/arm-linux-gnueabihf'],
                    libraries = [ 'brcmGLESv2', 'brcmEGL', 'openmaxil', 'bcm_host', 'vcos', 'vchiq_arm', 'pthread', 'rt', 'm', 'GL', 'Togl2.0', 'stdc++', 'Xmu', 'X11', 'tclstub8.6', 'tkstub8.6'],
